# COG Browser Template Specific Documentation

This template leverages from the Torizon IDE extension to provide an easy way to start a Cog web browser based project.
